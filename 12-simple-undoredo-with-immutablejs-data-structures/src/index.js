...
class Model {
  ...
  redo() {
    if (this.historyIndex < this.history.size) this.historyIndex++;
    ...
    return (
      <div className="drawing-canvas container">
        ...
        <div className="button-holder">
          <button onClick={this.handleUndo.bind(this)} disabled={undoDisabled}>
            Undo
          </button>
          <button onClick={this.handleRedo.bind(this)} disabled={redoDisabled}>
            Redo
          </button>
        </div>
      </div>
...
function renderComponent(props) {
  render(<DrawingCanvas {...props} />, document.getElementById("app"));
}
