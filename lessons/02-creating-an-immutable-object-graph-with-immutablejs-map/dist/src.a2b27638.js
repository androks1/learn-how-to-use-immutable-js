...
exports.createObjTodos = createObjTodos;
...
function createObjTodos(numTodos) {
  var obj = {};
  (0, _lodash.each)((0, _lodash.range)(numTodos), function (index) {
    var todoSequence = String(index + 1);
    obj["todo" + todoSequence] = {
      title: "Todo " + todoSequence,
      value: "Make ".concat(todoSequence, " happen")
    };
  });
  return obj;
}

var _default = createObjTodos; // function createObjTodos(numTodos) {
// var obj = {}
